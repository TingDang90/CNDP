...
class VaryRotMNIST(Dataset):
    ...
    def __init__(self, split='train', num_points=5000, num_velocity_perms=3, dt=0.1):
        ...
        savepath = os.path.join(os.path.dirname(os.getcwd()),'datasets', 'rot_mnist', 'vary_mnist.pt')
        if os.path.exists(savepath):
            ...
            with open(savepath, 'wb') as f:
                torch.save(Xtr, f)
            #torch.save(Xtr, '/Users/sally/Documents/Cambridge/Covid_19/code/python/ndp-main/datasets/rot_mnist/vary_mnist.pt')
